...
-- Dumping database structure for carpolling
CREATE DATABASE IF NOT EXISTS `carpolling` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `carpolling`;


-- Dumping structure for table carpolling.car
CREATE TABLE IF NOT EXISTS `car` (
  ...
  `RegistrationState` varchar(255) DEFAULT NULL,
...
-- Dumping structure for table carpolling.driver
...
-- Dumping structure for table carpolling.feedback
CREATE TABLE IF NOT EXISTS `feedback` (
  `feedbackid` varchar(255) NOT NULL,
  `feedbackby` varchar(255) DEFAULT NULL,
  `feedbackdate` varchar(255) DEFAULT NULL,
  `feedbackfor` varchar(255) DEFAULT NULL,
  `feedbackmsg` varchar(255) DEFAULT NULL,
...
-- Dumping structure for table carpolling.login
...
-- Dumping structure for table carpolling.requestinfo
...
-- Dumping database structure for cdcol
CREATE DATABASE IF NOT EXISTS `cdcol` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci */;
USE `cdcol`;


-- Dumping structure for table cdcol.cds
...
-- Dumping structure for table college.class1
...
-- Dumping structure for table employee.emp1
...
-- Dumping structure for table hibernate.employee
...
-- Dumping structure for table hibernate.student
CREATE TABLE IF NOT EXISTS `student` (
...
-- Dumping database structure for java9am
CREATE DATABASE IF NOT EXISTS `java9am` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `java9am`;


-- Dumping structure for table java9am.employee
CREATE TABLE IF NOT EXISTS `employee` (
...
-- Dumping structure for table java9am.login
CREATE TABLE IF NOT EXISTS `login` (
  `id` varchar(50) NOT NULL,
  `password` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Dumping structure for table librarydb.login
CREATE TABLE IF NOT EXISTS `login` (
  `username` varchar(255) NOT NULL,
  `password` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`username`)
...
-- Dumping structure for table librarydb.transaction
...
-- Dumping structure for table phpmyadmin.pma_bookmark
...
-- Dumping structure for table phpmyadmin.pma_column_info
...
-- Dumping structure for table phpmyadmin.pma_designer_coords
...
-- Dumping structure for table phpmyadmin.pma_history
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='SQL history';

-- Data exporting was unselected.


-- Dumping structure for table phpmyadmin.pma_pdf_pages
CREATE TABLE IF NOT EXISTS `pma_pdf_pages` (
  ...
  PRIMARY KEY (`page_nr`),
  KEY `db_name` (`db_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='PDF Relationpages for PMA';

-- Data exporting was unselected.


-- Dumping structure for table phpmyadmin.pma_relation
...
-- Dumping structure for table phpmyadmin.pma_table_coords
...
-- Dumping structure for table phpmyadmin.pma_table_info
...
-- Dumping structure for table phpmyadmin.pma_tracking
...
-- Dumping structure for table phpmyadmin.pma_userconfig
...
-- Dumping database structure for results
CREATE DATABASE IF NOT EXISTS `results` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `results`;


-- Dumping structure for table results.adminlogin
...
-- Dumping structure for table results.marks
CREATE TABLE IF NOT EXISTS `marks` (
  ...
  `sessionaltype` varchar(50) DEFAULT NULL,
  `subject` varchar(50) DEFAULT NULL,
  `maximum` int(10) DEFAULT NULL,
  `minimum` int(10) DEFAULT NULL,
  `obtained` int(10) DEFAULT NULL,
  PRIMARY KEY (`entryid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Dumping structure for table results.student
CREATE TABLE IF NOT EXISTS `student` (
...
-- Dumping database structure for struttable
CREATE DATABASE IF NOT EXISTS `struttable` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `struttable`;


-- Dumping structure for table struttable.employee
CREATE TABLE IF NOT EXISTS `employee` (
  `id` varchar(50) NOT NULL,
  `name` varchar(50) NOT NULL,
  `gender` varchar(50) NOT NULL,
...
-- Dumping database structure for webauth
CREATE DATABASE IF NOT EXISTS `webauth` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci */;
USE `webauth`;


-- Dumping structure for table webauth.user_pwd
