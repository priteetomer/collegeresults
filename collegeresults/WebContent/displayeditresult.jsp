		...
		<div class="content">
			...
			<div class="rightpart">
				...
				<c:if test="${ob.marks ne null}">
					...
					<input type="hidden" name="entryid" value="${marks.entryid}"/>
					<div class="row">
						<div class="labelsub">
							<input type="text" name="subject" value="${marks.subject}" class="txte"/>
						</div>
						<div class="labeladd">
							<input type="text" name="maximum" value="${marks.maximum}" class="txte"/>
						</div>
						<div class="labeladd">
							<input type="text" name="minimum" value="${marks.minimum}" class="txte"/>
						</div>
						<div class="labeladd">
							<input type="text" name="obtained" value="${marks.obtained}" class="txte"/>
						</div>
						<div class="clear"></div>
					</div>
					</c:forEach>
